...
var sage_mode = new Ability("Sage Mode", "Activate Phoenix Sage Mode, boosting attack damage.", 1, "utility", "self", "special", "no", 40, 0, 0, new StatusEffect("Sage Mode", "This unit has extra strength", "Buff", "buff", 3, 50, "attack"), 1.00)
