...
//Initialize enemy party -- This needs a better implementation method
...
var shuriken_jutsu = new Ability("Shuriken Jutsu", "A barrage of Shuriken are launched at lightning fast speed to deal damage.", 1, "Wind", "damage", "single", "special", "no", 10, 100, 0.05, "NA", 0.10);
var fireball = new Ability("Fireball", "Launch a Fireball at a single target dealing magic damage.", 1, "Fire", "damage", "single", "spell", "no", 10, 75, 0.05, 
	new StatusEffect("Burn", "This unit takes ticking burn damage each turn.", "OverTime", "dot", 3, 10, "NONE"), 1.00);
var phoenix_fire = new Ability("Phoenix Fire", "Launch a five count Phoenix Fire jutsu at the enemy.", 1, "Fire", "damage", "multi-target", "spell", "no", 20, 150, 0.05, new StatusEffect("Burn", "This unit takes ticking burn damage each turn.", "OverTime", "dot", 3, 15, "NONE"), 1.00);
var holy_light = new Ability("Holy Light", "Bless the target with holy light, healing minor wounds.", 1, "Holy", "healing", "Nature", "single", "spell", "no", 20, 50, 0.05, "NA", 0);
var shatter = new Ability("Shatter", "Use Holy Light to incapacitate an enemy for 2 turns.", 1, "Holy", "damage", "single", "special", "no", 15, 45, 0.05, new StatusEffect("Stun", "This unit is incapacitated and cannot act.", "Incapacitate", "NONE", 2, 0, "NONE"), 1.00);
var sage_mode = new Ability("Sage Mode", "Activate Phoenix Sage Mode, boosting attack damage.", 1, "Fire", "healing", "self", "special", "no", 40, 0, 0, new StatusEffect("Sage Mode", "This unit has extra strength", "Buff", "buff", 0, 50, "attack"), 1.00)
var daze_palm = new Ability("Daze Palm", "Strike the target with a palm force hard enough to disorient them.", 1, "Earth", "damage", "single", "special", "no", 25, 60, 0.05, new StatusEffect("Dazed", "This unit is in a disoriented state, making their actions unpredictable and random.", "Disorient", "NONE", 2, 0, "NONE"), 1.00);
var poisonous_cupcake = new Ability("Poisonous Cupcake", "Force-feed a poisonous cupcake to an opponent and poison them.", 1, "Nature", "damage", "single", "special", "no", 20, 50, 0.05, new StatusEffect("Food Poisoning", "This unit is ill from food poisoning and taking damage every turn.", "OverTime", "dot", 3, 20, "NONE"), 1.00);
var restorative_foodpill = new Ability("Restorative Foodpill", "Give a rejuvanating foodpill to an ally, restoring health for 3 turns.", 1, "Earth", "healing", "single", "special", "no", 40, 25, 0.05, new StatusEffect("Rejuvanation", "Restoring Health each turn.", "OverTime", "hot", 3, 25, "NONE"), 1.00);
var cha_nara = new Ability("Chaa-naraa!", "Sakura's inner spirit bolsters her next attack causing high physical damage.", 1, "Earth", "damage", "single", "special", "no", 20, 200, 0.20, "NA", 0);
var holy_3 = new Ability("Holy III", "Heal all allies for an immense amount of healing.", 1, "Holy", "healing", "multi-target", "spell", "no", 50, 300, 0.50, "NA", 0);
var firaga = new Ability("Firaga", "Blast all enemies with huge fire damage", 1, "Fire", "damage", "multi-target", "spell", "no", 50, 300, 0.50, "NA", 0);
var first_aid = new Ability("First Aid", "Apply first aid to all party members.", 1, "Nature", "healing", "multi-target", "special", "no", 35, 200, 0.50, "NA", 0);

var mangekyou_sharingan = new Ability("Mangekyou Sharingan", "Ultimate Ability of Itachi.", 1, "Dark", "damage", "single", "special", "yes", 0, 250, 0.05, new StatusEffect("Genjutsu", "This unit is under a genjutsu", "Incapacitate", "NONE", 3, 0, "NONE"), 0.90);


//Player Party Initialization
...
//Enemy Ability Pushing and Setting
